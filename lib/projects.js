/* ═══════════════════════════════════════════════════════════════════════════
   ...
   `hidden: true` benches a project without deleting it. The entry stays here in
   full, but nibble-context.js drops it before building the index, so Nibble
   cannot cite it, retrieve it, or open it. Its card in index.html is commented
   out to match. Remove both to bring a project back.
═══════════════════════════════════════════════════════════════════════════ */
